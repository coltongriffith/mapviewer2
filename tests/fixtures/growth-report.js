...
export const growthReport = {
  funnel: { sessions: 24, engaged: 16, opened: 12, imported: 8, exported: 3, real_exported: 2 },
  ...
  sources: [{ source: 'founder / outreach', sessions: 24, engaged: 16, opened: 12, imported: 8, exported: 3, real_exported: 2 }],
