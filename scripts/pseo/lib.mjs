...
//
// The algorithm and thresholds live in api/_lib/name-match.js so the runtime
// US claimant resolver in api/claims.js scores names identically to this
// pipeline. Re-exported here so existing pipeline imports are unchanged.

export { normalizeName, nameTokens, nameScore, NAME_MATCH } from '../../api/_lib/name-match.js';
